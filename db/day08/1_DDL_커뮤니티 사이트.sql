...
CREATE TABLE `post_file` (
	`pf_num`	int primary key auto_increment	NOT NULL,
	`pf_ori_name`	varchar(255)	NOT NULL,
	`pf_name`	varchar(255)	NOT NULL,
	`pf_po_num`	int	NOT NULL
);
...
ALTER TABLE `post_file` ADD CONSTRAINT `FK_post_TO_post_file_1` FOREIGN KEY (
	`pf_po_num`
)
REFERENCES `post` (
	`po_num`
